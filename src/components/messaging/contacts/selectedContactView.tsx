...
const SelectedContactView = (props: PropType) => {
  ...
  return (
    <div className="flex flex-col gap-2 items-center m-2 h-full w-full min-h-0">
      <div className="w-full flex flex-row my-4">
        <Button isIconOnly variant="light" onClick={() => setSelectedUser(undefined)}>
          <IconArrowBack />
        </Button>
      ...
      <div className="flex flex-col gap-8 w-full text-center items-center px-2 flex-1 min-h-0">
